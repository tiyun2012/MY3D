...
#endif
//#pragma comment(lib, "opengl32.lib") // this set in project linker
...
Application* gApplication = 0;//nullptr;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
	...
	DWORD style = (WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX| WS_THICKFRAME); // WS_THICKFRAME to resize
	AdjustWindowRectEx(&windowRect, style, TRUE, 1);
	...
	while (true) {
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
			...
			std::cout << "Window Handle (HWND): " << msg.hwnd << std::endl;*/
			//std::cout << "wParam: " << msg.wParam << std::endl;
		...
		//std::cout << "thisTick: " << thisTick << std::endl;
		lastTick = thisTick;
		if (gApplication != 0) {
